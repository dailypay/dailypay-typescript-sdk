...
export const startCommand = buildCommand({
  ...
  parameters: {
    flags: {
      ...
      "oauth-user-token": {
        kind: "parsed",
        brief: "Sets the oauthUserToken auth field for the API",
        optional: true,
        parse: (value) => {
          return z.string().parse(value);
        },
      ...
      "token-url": {
        ...
        optional: false,
        default: "https://api.dailypay.com/oauth/token",
        parse: (value) => {
          return z.string().default("https://api.dailypay.com/oauth/token")
            .parse(value);
        },
      },
      "api-version": {
        ...
        optional: true,
        parse: (value) => {
          return z.coerce.number().int().default(3).parse(value);
        },
      },
      "server-url": {
        kind: "parsed",
