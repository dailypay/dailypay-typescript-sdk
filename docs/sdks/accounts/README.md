...
<!-- UsageSnippet language="typescript" operationID="listAccounts" method="get" path="/rest/accounts" example="AllAccounts" -->
```typescript
import { SDK } from "@dailypay/dailypay";
...
<!-- UsageSnippet language="typescript" operationID="listAccounts" method="get" path="/rest/accounts" example="ODPAccounts" -->
```typescript
import { SDK } from "@dailypay/dailypay";
...
<!-- UsageSnippet language="typescript" operationID="createAccount" method="post" path="/rest/accounts" example="Card" -->
```typescript
import { SDK } from "@dailypay/dailypay";
...
<!-- UsageSnippet language="typescript" operationID="createAccount" method="post" path="/rest/accounts" example="Depository" -->
```typescript
import { SDK } from "@dailypay/dailypay";
