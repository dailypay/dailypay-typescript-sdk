 ...
 */
export function accountsDeleteAccount(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteAccountRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteAccountResponse$inboundSchema),
